...
1. 서버 개발자와 협의 하여, success 한 상태가 아닌 상황에 대한 커스텀 예외와 Error 타입을 정의한다.
    ...
    - <img width="400" alt="스크린샷 2023-12-10 21 55 31" src="https://github.com/2taezeat/imageRepo/assets/59787852/3b03232f-61f1-42d7-85c4-17377129c3c1">
...
2. `OkHttp Interceptor`를 활용해서, 발생 가능한, data layer의 `네트워크 예외(IOException)`를 throw 한다.
    - <img width="400" alt="3" src="https://github.com/2taezeat/imageRepo/assets/59787852/a29e7a8b-4e56-420a-ab21-fe253638850d">

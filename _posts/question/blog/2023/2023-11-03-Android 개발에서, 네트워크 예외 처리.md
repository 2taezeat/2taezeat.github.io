...
- data layer 와 domain layer의 예외가 **Presentation layer 에서 catch** 가능하게 한다.
...
<img width="450" alt="3" src="https://github.com/2taezeat/imageRepo/assets/59787852/a29e7a8b-4e56-420a-ab21-fe253638850d">

<img width="450" alt="스크린샷 2023-12-10 21 55 31" src="https://github.com/2taezeat/imageRepo/assets/59787852/3b03232f-61f1-42d7-85c4-17377129c3c1">
...
2. 발생 가능한 data layer의 예외(IOException)는 `Interceptor`를 활용해 처리한다.
3. **viewModel**에서, `CoroutineExceptionHandler`를 선언하고, 여기서 일관되게 Error에 대한 **Event**를 발생시킨다. (예외 처리를 한다.)
4. Error Event 에 대해서, 유저에게 보여주는 방법은 일관되게 한다.
    - 아래의 확장 함수를 모든 **Fragment**에서 사용해서 동일하게 Error 이유를 **Toast or SnackBar**로 보여준다.
